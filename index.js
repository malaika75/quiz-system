...
let answer = await inquirer.prompt([
    ...
    },
    {
        name: "Q1",
        type: "list",
        message: "Which of the following is the correct way to declare a variable in TypeScript?",
        choices: [
            "A. let num: number = 10",
            "B. var num: 10",
            "C. num number = 10",
...
let select = await inquirer.prompt({
    name: "Q2",
    type: "list",
    message: "Which TypeScript feature allows you to catch errors at compile time instead of runtime?",
    choices: [
        "A. Type Inference",
        "B. Type Annotations",
        "C. Interfaces",
...
let select5 = await inquirer.prompt({
    name: "Q5",
    type: "list",
    message: "Which of the following statements regarding the scope of variables declared with let in TypeScript is true?",
    choices: [
